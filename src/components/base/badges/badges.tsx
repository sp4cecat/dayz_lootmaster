...
const withPillTypes = {
    ...
    [badgeTypes.badgeModern]: {
        common: "size-max flex items-center whitespace-nowrap rounded-md ring-1 ring-inset bg-white text-secondary dark:bg-gray-900 dark:text-gray-300 ring-gray-300 dark:ring-gray-700 shadow-xs",
