...
export const Sidebar = ({ 
  ...
  return (
    <aside className={cn("flex flex-col h-full bg-white border-r border-gray-200 w-72", className)}>
      <div className="p-6 flex items-center gap-3">
        <div className="size-8 bg-primary-600 rounded-lg flex items-center justify-center text-white">
          <Database size={20} />
        </div>
        <span className="text-xl font-bold text-gray-900 tracking-tight">Lootmaster</span>
      </div>
      ...
      <div className="px-4 mb-4">
        <div className="relative">
          ...
          <input 
            type="text" 
            placeholder="Search..." 
            className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-100 focus:border-primary-300 transition-all"
          />
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-200 space-y-4">
        <button 
          ...
          className="flex items-center w-full px-3 py-2 text-sm font-semibold text-gray-700 rounded-lg hover:bg-gray-50 transition-colors"
        >
        ...
        <div className="flex items-center gap-3 px-3 py-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-gray-900 truncate">{editorID}</p>
            <p className="text-xs text-gray-500 truncate">Editor Session</p>
          </div>
          <button 
            onClick={onSignOut}
