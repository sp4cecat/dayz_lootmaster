...
export const Button = React.forwardRef(({ className, variant = 'primary', size = 'md', ...props }, ref) => {
  const variants = {
    primary: 'bg-primary-600 text-white hover:bg-primary-700 shadow-sm border border-primary-600',
    ...
    error: 'bg-error-600 text-white hover:bg-error-700 shadow-sm border border-error-600',
    link: 'text-primary-700 hover:text-primary-800 p-0 h-auto',
  };
